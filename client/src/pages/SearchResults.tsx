...
const SearchResults = () => {
  ...
  const [loading, setLoading] = useState(true);
  const [sort, setSort] = useState("relevance");
  // Set when the server forgave a typo, e.g. "bananna" -> "Banana Robusta 1kg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5">
            <div>
              ...
              {!loading && didYouMean && sortedProducts.length > 0 && (
                <p className="text-white text-sm mt-2 bg-white/15 inline-block px-3 py-1 rounded-full">
                  No exact match. Showing closest results, like{" "}
