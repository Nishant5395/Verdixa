...
//     contact: [
//         { icon: MapPinIcon, text: "Sheikhpura, Bihar" },
//         { icon: PhoneIcon, text: "+91 7856045698" },
//         { icon: MailIcon, text: "anand@gmail.com" },
//     ],
...
export const appPromoBannerData = {
    title: "Every order, held to the same standard",
    description: "Live tracking, flexible payment, and real support on every order.",
};
