...
// /**
//  * Gives an order's stock (and its coupon redemption) back.
//  * Safe to call more than once: the `stockReserved` flag is claimed atomically,
//  * so only the first call does anything. Returns true if it released something.
//  */
